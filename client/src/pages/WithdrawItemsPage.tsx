...
const WithdrawItemsPage: React.FC = () => {
  ...
  const addItemToWithdraw = (itemId: string) => {
    ...
    const maxStockLocation = itemStocks.reduce(
                ...
                <Table>
                  ...
                  <TableBody>
                    {withdrawItems.map((withdrawItem, index) => {
                      ...
                      const availableStock = getStockFromLocation(
                        withdrawItem.itemId,
                        withdrawItem.locationId
                      );
                      const isValidQuantity = canWithdraw(
                        withdrawItem.itemId,
                        withdrawItem.locationId,
                        ...
                        >
                          ...
                          <TableCell>
                            <Input
                              ...
                              onChange={(e) =>
                                updateWithdrawItem(index, 'quantity', parseInt(e.target.value) || 0)
                              }
                          ...
                          <TableCell>
                            <select
                              ...
                              onChange={(e) =>
                                updateWithdrawItem(index, 'locationId', e.target.value)
                              }

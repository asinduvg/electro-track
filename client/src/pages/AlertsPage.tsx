        ...
        <div className="min-h-screen bg-[#F7F7F7] dark:bg-[#222222]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                    <div>
                        <h1 className="text-3xl font-bold text-[#222222] dark:text-white">Alerts & Notifications</h1>
                        <p className="mt-2 text-[#717171]">Monitor and manage system alerts and notifications</p>
                    </div>
                </div>
                        ...
                        <CardContent className="p-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-[#222222] dark:text-white">{alerts.length}</p>
                                </div>
                    ...
                    <Card>
                        <CardContent className="p-4">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="h-3 w-3 bg-[#C4141C] rounded-full animate-pulse"></div>
                            </div>
                        </CardContent>
                    </Card>
                                            ...
                                            <TableCell>
                                                <div className="flex items-start space-x-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-sm text-[#717171] max-w-md">
                                                            {alert.message}
                                                        </div>
                                                        {alert.item_name && (

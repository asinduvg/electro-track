...
const ReportsPage: React.FC = () => {
  ...
  const isLoading =
    transactionsLoading || itemsLoading || locationsLoading || stocksLoading || categoriesLoading;
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Card>
          ...
          <CardContent>
            ...
            <Button variant="outline" className="w-full" onClick={() => generateInventoryReport()}>
              Generate Report
            </Button>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Button variant="outline" className="w-full" onClick={() => generateFinancialReport()}>
              Generate Report
            </Button>
          </CardContent>
        </Card>
                ...
                <TableBody>
                  {recentTransactions.map((transaction) => {
                    ...
                    const fromLocation = locations.find(
                      (loc) => loc.id === transaction.from_location_id
                    );
                    const toLocation = locations.find(
                      (loc) => loc.id === transaction.to_location_id
                    );

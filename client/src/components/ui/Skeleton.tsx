...
const Skeleton: React.FC<SkeletonProps> = ({ 
  ...
  const variantClasses = {
    ...
    shimmer: 'bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 dark:from-gray-700 dark:via-gray-600 dark:to-gray-700 bg-[length:200%_100%] animate-[shimmer_2s_ease-in-out_infinite]',
...
const ListItemSkeleton: React.FC<ListItemSkeletonProps> = ({
  ...
  return (
    <div className={cn('flex items-center space-x-4 p-4 border-b border-gray-200 dark:border-gray-700', className)}>
      {showAvatar && (

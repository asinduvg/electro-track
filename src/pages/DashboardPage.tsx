          ...
          <CardContent className="p-6">
            ...
            <div className="mt-4 flex items-center text-sm">
              {lowStockItems.length > 0 ? (
                <Link to="/inventory/items?filter=low_stock" className="flex items-center hover:underline">
          ...
          <CardContent>
            {lowStockItems.length > 0 ? (
              ...
              <div className="text-center py-8 text-gray-500">
                ...
                <p className="text-sm text-gray-400 mt-2">All items are above their minimum stock levels</p>
              </div>
            )}
          </CardContent>
        </Card>
